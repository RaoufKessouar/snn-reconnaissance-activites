...
os.environ.setdefault("NEURON", "relu")
...
LAST = OUT / "last_chain_tdbn_annrelu.pth"; BEST = OUT / "best_chain_tdbn_annrelu.pth"
run_name = f"madchain_ANNtdBN_L{SEQ_LEN}_T{T}_bs{BS}_ep{EPOCHS}"
