"""Evaluate the MAD-Chain L=3 checkpoint without test-set adaptation."""
...
print(
    f"[tdBN TEST] participants 86-100 | standard={standard_accuracy:.4f} "
...
if os.environ.get("RECALIBRATE_FROM_TRAIN") == "1":
    ...
    print(f"[tdBN TEST] train-recalibrated={evaluate():.4f} | calibration_batches={batches}")
