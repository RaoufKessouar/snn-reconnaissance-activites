...
os.environ.setdefault("NEURON", "qif")
...
LAST = OUT / "last_chain_tdbn_L4_qif.pth"; BEST = OUT / "best_chain_tdbn_L4_qif.pth"
run_name = f"madchain_TDBN_QIF_L{SEQ_LEN}_T{T}_bs{BS}_ep{EPOCHS}"
