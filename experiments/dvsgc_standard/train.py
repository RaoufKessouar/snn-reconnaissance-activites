...
run_name = "sresnet38_81p_bs4_accum2_ep100_lr1e-4_val"

best_checkpoint_path = str(Path(__file__).resolve().parent / "best_model_sresnet38_bs4_accum2_lr1e-4_val.pth")
last_checkpoint_path = str(Path(__file__).resolve().parent / "last_model_sresnet38_bs4_accum2_lr1e-4.pth")
