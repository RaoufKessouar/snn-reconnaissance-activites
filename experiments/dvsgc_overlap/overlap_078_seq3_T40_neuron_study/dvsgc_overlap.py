...
def make_class_combinations(seq_len, class_num, repeat):
    ...
    """
    permuted_classes = ['0','7','8','1','3','9','2','4','6','5']
...
class DVSGestureChain(DatasetFolder):
    def __init__(
        ...
        if dvsg_path is not None and os.path.exists(dvsg_path):
            ...
            source_events_np_root = events_np_root

        frames_np_root = os.path.join(root, f'DVSGC_overlap_078_seq{seq_len}_cls{class_num}_frames_{frames_number}_split_by_{split_by}')
