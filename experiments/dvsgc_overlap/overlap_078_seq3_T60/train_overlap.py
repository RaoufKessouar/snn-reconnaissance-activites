...
run_name = "sresnet38_overlap078_seq3_T60_bs8_retry_lr1e-4"

best_checkpoint_path = str(Path(__file__).resolve().parent / "checkpoints" / "best_model_overlap078_seq3_T60_bs4_accum2.pth")
last_checkpoint_path = str(Path(__file__).resolve().parent / "checkpoints" / "last_model_overlap078_seq3_T60_bs4_accum2.pth")
